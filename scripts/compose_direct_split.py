#!/usr/bin/env python3
"""Compose a faithful photo print beside a deterministic paper-cut collage paper field."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create a borderless photo-print and paper-cut collage paper composition."
    )
    ...
    parser.add_argument(
        ...
        type=unit_fraction,
        default=0.003,
        help="narrow contact-shadow blur as a fraction of the paper short side; keep small for subtle paper-collage look",
    )
...
def main() -> None:
    ...
    # Auto-correct EXIF orientation (phone photos may be rotated in metadata)
