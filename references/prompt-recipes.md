...
Style/medium: a flat, front-facing journal clipping physically assembled from approximately 8–15 coherent broad or medium hand-cut patterned paper pieces, adjusted to subject structure; solid colors and familiar regular patterns such as stripes, checks, grids, florals, botanical prints, and dots dominate; each piece shows visible paper fiber, soft edge fuzz, mild analog pigment variation, and overlap darkening; translate perspective or perceived volume into adjacent light, middle, and dark paper planes, overlap order, and negative-space cuts rather than drawn outlines; use only paper silhouettes, negative space, overlap seams, narrow paper strips, or paper patterns to define rims, handles, stems, grids, and structural edges; no graphite, pencil, pen, or ink outlines; no cast shadows or drop shadows; no inflated or sculptural paper volume
...
Style/medium: built from approximately 10–12 coherent hand-cut pieces of patterned paper; opaque layered paper pieces with visible fibrous edges, soft paper texture, and subtle overlap where papers stack. Each paper piece has soft torn fuzzy edges, mild color variation, clear overlap darkening. Paper patterns are subtle and refined like decorative patterned paper: warm white paper with fine stripe texture for main surfaces, pale gray paper for volumes, narrow paper strips for structural elements, soft muted blue paper with gentle wave texture for water, warm beige paper with fine dot pattern for ground. Patterns are understated, not loud. No cast shadows, no sculptural depth, no graphite outlines, no gradients, no photographic texture, no translucency.
...
Style/medium: physically assembled from approximately 8–15 coherent broad or medium pieces of hand-cut patterned paper, adjusted to subject structure and dominated by solid colors and familiar regular patterns such as stripes, checks, grids, florals, or dots; show paper fiber, soft edge fuzz, and mild analog pigment variation; use paper edges, overlaps, negative space, and narrow paper strips instead of graphite or ink outlines; no digital gradients, photographic texture, glossy vector fills, or ornate multicolor prints; no cast shadows or drop shadows
